...
#define H_API_RTLDESTROYHEAP		0xceb5349f /* RtlDestroyHeap */
...
D_SEC( D ) VOID WINAPI ExitThread_Hook( _In_ DWORD ExitCode )
{
	...
	Api.RtlDestroyHeap      = PeGetFuncEat( PebGetModule( H_LIB_NTDLL ), H_API_RTLDESTROYHEAP );
