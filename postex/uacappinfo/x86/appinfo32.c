...
typedef struct
{
	__typeof__( NdrAsyncClientCall ) * NdrAsyncClientCall;
} API ;
...
const RPC_CLIENT_INTERFACE LaunchAdminProcess___RpcClientInterface =
    {
...
RPC_BINDING_HANDLE LaunchAdminProcess__MIDL_AutoBindHandle;
    ...
    /* [out] */ long *ElevationType)
{
	...
	if ( Rpc != NULL ) {
		...
		/* Find API and call the API with the target arguments */
		Api.NdrAsyncClientCall = ( PVOID )( GetProcAddress( Rpc, "NdrAsyncClientCall" ) );
		Api.NdrAsyncClientCall(
...
const appinfo_MIDL_PROC_FORMAT_STRING appinfo__MIDL_ProcFormatString =
    {
        0,
        {
...
const appinfo_MIDL_TYPE_FORMAT_STRING appinfo__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
const unsigned short LaunchAdminProcess_FormatStringOffsetTable[] =
    {
    0
    };


const MIDL_STUB_DESC LaunchAdminProcess_StubDesc = 
    {
